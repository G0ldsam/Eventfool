...
namespace EventFool.Repository
{
    public class EventRepository : GenericRepository<Event>, IEventRepository
    {
        ...
        //public Event Read(string eventName, DateTime startDate, DateTime endDate, string locationName, string address, string city, string country)
        //{
        //    return _dbContext.Events.Include("Location").Where(e => e.Name == eventName && e.StartDate == startDate && e.EndDate == endDate && e.Location.Name == locationName).FirstOrDefault();
        //}
